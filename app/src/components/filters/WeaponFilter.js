...
const WeaponFilter = (props) => {
    return (
        <div className="filter-bar">
            ...
            <div className="filter">
                <img className="filter-off" id="claymore-button" src={claymoreIcon} alt="Claymore" onClick={(e) => props.onClick(e, "weapon")} />
                <p className="material-tooltip">Claymore</p>
            </div>
            <div className="filter">
                <img className="filter-off" id="polearm-button" src={polearmIcon} alt="Polearm" onClick={(e) => props.onClick(e, "weapon")} />
                <p className="material-tooltip">Polearm</p>
            </div>
            <div className="filter">
                <img className="filter-off" id="bow-button" src={bowIcon} alt="Bow" onClick={(e) => props.onClick(e, "weapon")} />
                <p className="material-tooltip">Bow</p>
            </div>
            <div className="filter">
                <img className="filter-off" id="catalyst-button" src={catalystIcon} alt="Catalyst" onClick={(e) => props.onClick(e, "weapon")} />
