...
const TalentFilter = (props) => {
    return (
        <div className="filter-bar">
            ...
            <div className="filter">
                <img className="filter-off" id="resistance-button" src={resistanceIcon} alt="Resistance" onClick={(e) => props.onClick(e, "talent")} />
                <p className="material-tooltip">{formatTalents("Resistance")}</p>
            </div>
            <div className="filter">
                <img className="filter-off" id="ballad-button" src={balladIcon} alt="Ballad" onClick={(e) => props.onClick(e, "talent")} />
                <p className="material-tooltip">{formatTalents("Ballad")}</p>
            </div>
            <div className="filter">
                <img className="filter-off" id="prosperity-button" src={prosperityIcon} alt="Prosperity" onClick={(e) => props.onClick(e, "talent")} />
                <p className="material-tooltip">{formatTalents("Prosperity")}</p>
            </div>
            <div className="filter">
                <img className="filter-off" id="diligence-button" src={diligenceIcon} alt="Diligence" onClick={(e) => props.onClick(e, "talent")} />
                <p className="material-tooltip">{formatTalents("Diligence")}</p>
            </div>
            <div className="filter">
                <img className="filter-off" id="gold-button" src={goldIcon} alt="Gold" onClick={(e) => props.onClick(e, "talent")} />
